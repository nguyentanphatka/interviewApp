...
using InterviewApp.Core.ProjectAggregate;
using InterviewApp.Core.ProjectAggregate.Events;
using InterviewApp.Core.ProjectAggregate.Handlers;
using Moq;
using System;
...
namespace InterviewApp.UnitTests.Core.Handlers
{
